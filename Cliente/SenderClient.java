...
public class SenderClient extends Thread{
    ...
    public SenderClient(DatagramSocket nuevoSocket, String servidor, int puertoServidor){
        socket = nuevoSocket;
        SERVER=servidor;
    ...
    public void run() {
        ...
        try {
            ...
            do {
                ...
                System.out.println("Mensaje \""+ mensajeMandado +"\" enviado a "+paquete.getAddress() + "#"+paquete.getPort());
